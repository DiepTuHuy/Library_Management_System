...
class BorrowRecord:
    ...
    # Status constants
    STATUS_BORROWING = "BORROWING"    # Currently borrowing
    STATUS_RETURNED = "RETURNED"      # Successfully returned on time
    STATUS_OVERDUE = "OVERDUE"        # Returned but past due date
    STATUS_LATE = "LATE"              # Currently overdue
